...
class retinanet(object):
    ...
    def __init__(self, class_num, anchors, use_label_smooth=False, use_focal_loss=True, batch_norm_decay=0.999,
    ...
    def forward(self, inputs, is_training=False, reuse=False):
        ...
        with slim.arg_scope([slim.conv2d, slim.batch_norm], reuse=reuse):
            with slim.arg_scope([slim.conv2d],
                ...
                with tf.variable_scope('retinanet_backbone'):
                    route_1, route_2, route_3 = retinanet_backbone_body(inputs, )
