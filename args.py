...
### Some paths
train_file = './data/my_data/jinju_display.txt'  # The path of the training txt file.
val_file = './data/my_data/jinju_display.txt'  # The path of the validation txt file.
restore_path = './checkpoint/best_model_Epoch_80_step_5507_mAP_-inf_loss_1.7480_lr_1e-05'  # The path of the weights to restore.
...
anchor_path = './data/my_data/jinju_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/my_data/jinju.names'  # The path of the class names.
